      ...
      <div className="text-center space-y-6">
        ...
        <div className="grid grid-cols-3 gap-4 max-w-md mx-auto pt-4">
          <div className="bg-excel/10 p-4 rounded-xl text-center">
            <div className="text-2xl font-bold text-excel">{formData.questions.length}</div>
      ...
      <Card className="border-border">
        <div className="bg-excel/5 p-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-xl font-semibold text-forms">{formData.title}</h3>
          ...
          <div className="grid md:grid-cols-2 gap-6 pt-6 border-t border-border">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button
                  size="sm"
                  onClick={() => handleCopyToClipboard(formData.formUrl, '¡Enlace copiado al portapapeles!')}
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <Button
                  size="sm"
                  onClick={() => handleCopyToClipboard(formData.editUrl, '¡Enlace copiado al portapapeles!')}
